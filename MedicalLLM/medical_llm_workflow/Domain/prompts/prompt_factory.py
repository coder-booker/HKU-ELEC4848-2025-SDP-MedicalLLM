...
# 该模块集中维护多语言提示片段，并根据提示类型组合生成模板列表。
# 对于 SELF_REFINE，会返回多阶段模板（初答/审查/修订）。
# """
# from medical_llm_workflow.Domain.prompts.models import PromptTemplate, PromptType
# from medical_llm_workflow.schemas.models import LanguageType
...
# # def build_prompt(prompt_template: PromptTemplate) -> str:
# #     """根据提示词模板和参数字典生成最终提示词字符串。"""
# #     prompt = prompt_template.text
# #     args_map = prompt_template.parameters
